...
<body>
    ...
    <div class="wrapper">
        <main class="doctorMain-section">
            <div class="container text-center py-5 my-5">
                <h1>Our Doctors</h1>
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 my-5">
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-4 shadow-lg">
                            <div class="d-flex flex-column h-100">
                                <div class="card-body">
                                    <img src="./images/james_rodriguez.jpg" style="border-radius: 50%; width: 170px;">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-4 shadow-lg">
                            <div class="d-flex flex-column h-100">
                                <div class="card-body">
                                    <img src="./images/sarah_williams.jpg" style="border-radius: 50%; width: 170px;">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-4 shadow-lg">
                            <div class="d-flex flex-column h-100">
                                <div class="card-body">
                                    <img src="./images/alex_johnson.jpg" style="border-radius: 50%; width: 170px;">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-4 shadow-lg">
                            <div class="d-flex flex-column h-100">
                                <div class="card-body">
                                    <img src="./images/olivia_davis.jpg" style="border-radius: 50%; width: 170px;">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-4 shadow-lg">
                            <div class="d-flex flex-column h-100">
                                <div class="card-body">
                                    <img src="./images/mason_tyler.jpg" style="border-radius: 50%; width: 170px;">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-4 shadow-lg">
                            <div class="d-flex flex-column h-100">
                                <div class="card-body">
                                    <img src="./images/sophia_martinez.jpg" style="border-radius: 50%; width: 170px;">
